...
try {
$gather=$fetch->query("SELECT * FROM product ");
...
foreach ($gather as  $val) {
 echo "
    <a class='btn btn-success btn-sm ml-5' href='../5.Limiting_Records_in_SQL_Queries/01_Limit.php?id="."1"."'>Add to Card </a> 
    </figure>";
    echo
"
...
<img class='img-thumbnail figure-img' src='../2.Query The Result/".$val['img']."'  width='200px' >
 <a class='btn btn-success btn-sm ml-5' href='../5.Limiting_Records_in_SQL_Queries/01_Limit_Reversing.php?id=".$val['sku']."'>Add to Card </a> 
</figure>
</div>
";
/*
